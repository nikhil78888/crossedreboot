...
const BANK: TriviaQuestion[] = [
  ...
  { id: "mus-n1", category: "Music", difficulty: "hard", q: "Which producer pioneered the 'Wall of Sound' recording technique?", choices: ["Phil Spector","Quincy Jones","George Martin","Berry Gordy"], answer: 0 },
  { id: "mus-n2", category: "Music", difficulty: "hard", q: "Which genre directly preceded reggae in late-1960s Jamaica?", choices: ["Rocksteady","Ska","Dub","Calypso"], answer: 0 },
  { id: "mus-n3", category: "Music", difficulty: "hard", q: "Jimi Hendrix's late-1960s backing band was called The ___.", choices: ["Experience","Wailers","Heartbreakers","Attractions"], answer: 0 },
  { id: "mus-n4", category: "Music", difficulty: "hard", q: "Which song was the first music video aired on MTV in 1981?", choices: ["Video Killed the Radio Star","Money for Nothing","Thriller","Bohemian Rhapsody"], answer: 0 },
  { id: "mus-n5", category: "Music", difficulty: "hard", q: "What is the lowest female singing voice type?", choices: ["Contralto","Soprano","Mezzo-soprano","Alto"], answer: 0 },
  { id: "mus-n6", category: "Music", difficulty: "hard", q: "Which bassist and singer fronted the band Motorhead?", choices: ["Lemmy Kilmister","Ozzy Osbourne","Ronnie James Dio","Bruce Dickinson"], answer: 0 },
  { id: "mus-n7", category: "Music", difficulty: "hard", q: "The Roland TR-808 is a famous piece of what equipment?", choices: ["Drum machine","Synthesizer","Sampler","Electric organ"], answer: 0 },
  { id: "mus-n8", category: "Music", difficulty: "hard", q: "Which group released the 1988 album 'Straight Outta Compton'?", choices: ["N.W.A","Public Enemy","Run-DMC","Wu-Tang Clan"], answer: 0 },
  { id: "mus-n9", category: "Music", difficulty: "hard", q: "Which was the last studio album The Beatles recorded together?", choices: ["Abbey Road","Let It Be","Revolver","Rubber Soul"], answer: 0 },
  { id: "mus-n10", category: "Music", difficulty: "hard", q: "Which 1969 festival was held on a dairy farm in Bethel, New York?", choices: ["Woodstock","Monterey Pop","Isle of Wight","Altamont"], answer: 0 },
  { id: "mus-n11", category: "Music", difficulty: "hard", q: "Which British band released the 1997 album 'OK Computer'?", choices: ["Radiohead","Blur","Oasis","Pulp"], answer: 0 },
  { id: "mus-n12", category: "Music", difficulty: "medium", q: "Which pop star is nicknamed the 'Material Girl'?", choices: ["Madonna","Cyndi Lauper","Cher","Whitney Houston"], answer: 0 },
  { id: "mus-n13", category: "Music", difficulty: "medium", q: "The band Nirvana helped popularize which 1990s genre?", choices: ["Grunge","Britpop","Punk","New wave"], answer: 0 },
  { id: "mus-n14", category: "Music", difficulty: "medium", q: "Which instrument has 88 keys in its standard form?", choices: ["Piano","Accordion","Organ","Harpsichord"], answer: 0 },
];
...
export const generateTrivia = (
  ...
  const shuffleArr = (a: TriviaQuestion[]) => {
  ...
  let ordered: TriviaQuestion[];
  if (excludeIds && excludeIds.length) {
    const seen = new Set(excludeIds);
    const unseen = shuffleArr(pool.filter((q) => !seen.has(q.id)));
    const seenPool = shuffleArr(pool.filter((q) => seen.has(q.id)));
    ordered = [...unseen, ...seenPool];
  } else {
    ordered = shuffleArr([...pool]);
  }
  ...
  const questions = ordered.slice(0, TRIVIA_COUNT).map((qn) => {
